...
namespace Lean.Touch
{
    ...
    public partial class LeanTouch : MonoBehaviour
    {
        ...
        public static float CurrentTapThreshold => Instances.Count > 0 ? Instances[0].TapThreshold : DefaultTapThreshold;
        ...
        public static float CurrentSwipeThreshold => Instances.Count > 0 ? Instances[0].SwipeThreshold : DefaultSwipeThreshold;
        ...
        public static LayerMask CurrentGuiLayers => Instances.Count > 0 ? Instances[0].GuiLayers : (LayerMask)Physics.DefaultRaycastLayers;
            ...
            if (FingerTexture != null && Input.touchCount == 0 && Fingers.Count > 1)
            {
                for (var i = Fingers.Count - 1; i >= 0; i--)
                {
                    ...
                    if (finger.Up == false)
                    {
                        ...
                        {
                            center = new Vector2(screenPosition.x, Screen.height - screenPosition.y)
                        };
        ...
        private void UpdateEvents()
        {
            ...
            if (fingerCount > 0)
            {
                for (var i = 0; i < fingerCount; i++)
                {
                    ...
                    if (finger.Tap == true && OnFingerTap != null)
                    {
                        OnFingerTap(finger);
                    }

                    if (finger.Swipe == true && OnFingerSwipe != null)
                    {
                    ...
                    if (finger.Set == true && OnFingerSet != null)
                    {
                        OnFingerSet(finger);
                    }
